...
import { bg, collections, newProduct, shape } from '../Helpers/images';
        ...
        <Fragment>
                                ...
                                <div className="group" key={index}>
                                    <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                        ...
                                        <ul className="list-none absolute top-[10px] start-4">
                                            ...
                                            {item.tag === 'Latest' && (
                                                <li><Link to="#" className="bg-gray-800 text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5">{item.tag}</Link> </li>
                                            )}
                                        </ul>
                                    </div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="flex justify-between items-center mt-1">
                                           ...
                                           <ul className="font-medium flex gap-1 list-none">
                                            {[...Array(5)].map((_, index) => (
                                                <li key={index}>
                                                <Link to="#" className={`flex`}>
                                                    <FaRegStar className={index < getRatingNumber(item.rating) ? 'text-amber-400' : 'text-gray-400'} />
                                                </Link>
                                                </li>
                                            ))}
                                            </ul>
            ...
            <section>
                ...
                <div className="grid grid-cols-1">
                    <div className="relative overflow-hidden py-24 px-4 md:px-10 bg-orange-600 bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url(${bg})`}}>
                        <div className="absolute inset-0 bg-center bg-no-repeat bg-cover" style={{backgroundImage:`url(${shape})`}}></div>
